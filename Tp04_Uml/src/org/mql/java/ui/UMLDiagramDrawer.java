...
public class UMLDiagramDrawer extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new UMLDiagramDrawer(customProject));
    }
}
...
class UMLPanel extends JPanel {
    ...
    private final int diagramSpacing = 50;  // Ajustez l'espace entre les diagrammes ici
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (CustomPackage customPackage : packages) {
            for (CustomClass customClass : customPackage.getClasses()) {
                ...
                x += 300 + diagramSpacing;  // Ajout de l'espace entre les diagrammes
            }
        }
    }
